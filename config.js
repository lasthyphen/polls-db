...
//dijets
// note: there is no v1 of DSCHIEF or VOTE_PROXY_FACTORY deployed to goerli, only the newer versions
const MKR_DIJETS_ADDRESS = '0xEFbe9981E4bdc773Bb438ceC391A40efA5BbF33E';
const BATCH_VOTING_CONTRACT_DIJETS_ADDRESS =
  '0x2c17cF8032469ef943dF192dFf678826F03F50da';
const ESM_ADDRESS_DIJETS = '0x02EB519F5978FA794706d719154481D0801F060e';
const ESM_V2_ADDRESS_DIJETS = '0x6F101749A8260580eD8Ae5513d8D75bcEd59Ec40';
const DSCHIEF_12_DIJETS_ADDRESS = '0x23Cb958bE9fdD002606E99bC032E55C8C2a6D433';
const VOTE_PROXY_FACTORY_12_DIJETS_ADDRESS =
  '0xc3e785313e3d52a66c20291e78cf399E4c9D9246';
const VOTE_DELEGATE_FACTORY_DIJETS_ADDRESS =
  '0xE5967bD2f18dC73ABe81DDA1f4305B8379809C6e';
...
const dijets = {
  ...
  extractors: [
    ...makeRawLogExtractors([
      BATCH_VOTING_CONTRACT_DIJETS_ADDRESS,
      MKR_DIJETS_ADDRESS,
      ESM_ADDRESS_DIJETS,
      ESM_V2_ADDRESS_DIJETS,
      DSCHIEF_12_DIJETS_ADDRESS,
      VOTE_PROXY_FACTORY_12_DIJETS_ADDRESS,
      VOTE_DELEGATE_FACTORY_DIJETS_ADDRESS,
    ]),
  ],
  transformers: [
    pollingTransformer(BATCH_VOTING_CONTRACT_DIJETS_ADDRESS),
    mkrTransformer(MKR_DIJETS_ADDRESS),
    mkrBalanceTransformer(MKR_DIJETS_ADDRESS),
    esmTransformer(ESM_ADDRESS_DIJETS),
    esmV2Transformer(ESM_V2_ADDRESS_DIJETS),
    dsChiefTransformer(DSCHIEF_12_DIJETS_ADDRESS, '_v1.2'),
    chiefBalanceTransformer(DSCHIEF_12_DIJETS_ADDRESS, '_v1.2'),
    voteProxyFactoryTransformer(VOTE_PROXY_FACTORY_12_DIJETS_ADDRESS, '_v1.2'),
    voteDelegateFactoryTransformer(VOTE_DELEGATE_FACTORY_DIJETS_ADDRESS),
  ],
  migrations: {
    mkr: './migrations',
  },
