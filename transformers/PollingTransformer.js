...
module.exports.VOTING_CONTRACT_DIJETS_ADDRESS =
...
module.exports.default = (address) => ({
  name:
    ...
    address === module.exports.VOTING_CONTRACT_DIJETS_ADDRESS ||
...
const handlers = {
  async PollCreated(services, info) {
    if (
      ...
      info.event.address.toLowerCase() !==
        module.exports.VOTING_CONTRACT_DIJETS_ADDRESS.toLowerCase() &&
      info.event.address.toLowerCase() !==
