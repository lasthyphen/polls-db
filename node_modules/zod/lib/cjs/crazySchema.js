...
exports.crazySchema = z.object({
    ...
    sumTransformer: z.transformer(z.array(z.number()), z.number(), function (arg) {
        return arg.reduce(function (a, b) { return a + b; }, 0);
    }),
    sumMinLength: z.array(z.number()).refine(function (arg) { return arg.length > 5; }),
...
exports.asyncCrazySchema = exports.crazySchema.extend({
    async_transform: z.transformer(z.array(z.number()), z.number(), function (arg) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, arg.reduce(function (a, b) { return a + b; }, 0)];
        });
    }); }),
    async_refine: z.array(z.number()).refine(function (arg) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2, arg.length > 5];
    }); }); }),
});
//# sourceMappingURL=crazySchema.js.map